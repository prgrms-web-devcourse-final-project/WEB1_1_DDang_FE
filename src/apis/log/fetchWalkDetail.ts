...
export type WalkDetailResponse = WalkDetail[]

export const fetchWalkDetail = async (req: WalkDetailRequest): Promise<APIResponse<WalkDetailResponse>> => {
  try {
