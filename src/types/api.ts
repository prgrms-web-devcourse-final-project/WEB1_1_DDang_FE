import { ChatType, Gender, FamilyRole, DayOfWeek, Provider } from '~types/common'
...
export type CommonAPIResponse = {
  ...
  date: string
  /**
   * ! 위치 포인트 @example "[{lat: 37.5665, lng: 126.9780}]"
   * */
  points: string
  ...
  /** 회원 성별 @example "MALE" */
  memberGender: Gender
  /** 회원 프로필 이미지 URL @example "https://example.com/profile.jpg" */
  ...
  /** 회원 이메일 @example "user@example.com" */
  memberEmail: string
